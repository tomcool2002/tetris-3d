...
export class Controls{
    constructor(scene){
        ...
        loader.load('./misc/keycaps.gltf', addingFunc);
    ...
    Loading(gltf) {
        ...
        this.scene.add(up_arrow_mesh);
        this.scene.add(down_arrow_mesh);
        this.scene.add(rigth_arrow_mesh);
        this.scene.add(left_arrow_mesh);
        this.scene.add(h_mesh);
        this.scene.add(left_mesh);
        this.scene.add(right_mesh);
        this.scene.add(turn_arrow_mesh);
        this.scene.add(exchange_mesh);
        this.scene.add(down_arrow);
